...
type UsageEvent struct {
	...
	CacheHitInputTokens  int64  `json:"cache_hit_input_tokens,omitempty"`
	CacheMissInputTokens int64  `json:"cache_miss_input_tokens,omitempty"`
...
func newUsageEvent(ctx context.Context, record coreusage.Record) UsageEvent {
	...
	inputTokens, outputTokens, reasoningTokens, cachedTokens, cacheHitInputTokens, cacheMissInputTokens, totalTokens := normaliseEventTokens(record.Detail)
...
func normaliseEventTokens(detail coreusage.Detail) (int64, int64, int64, int64, int64, int64, int64) {
	...
	cacheReadTokens := normaliseEventToken(detail.CacheReadTokens)
	...
	if cacheHitInputTokens > inputTokens {
		cacheHitInputTokens = inputTokens
	}
	cacheMissInputTokens := int64(0)
	if inputTokens > cacheHitInputTokens {
		cacheMissInputTokens = inputTokens - cacheHitInputTokens
	}
	if totalTokens == 0 {
		totalTokens = inputTokens + outputTokens + reasoningTokens
	}
	return inputTokens, outputTokens, reasoningTokens, cachedTokens, cacheHitInputTokens, cacheMissInputTokens, totalTokens
}
