...
func (s *Server) setupRoutes() {
	...
	openaiV1.Use(s.postAuthMiddleware()...)
	{
	...
	codexDirect.Use(s.postAuthMiddleware()...)
	{
...
// The handler is served after conditional auth and yui.web managed key status checks.
